...
;(function() {
  ...
  const css = `
    ...
    /* Header: 48px tall, 32px logo, pink gradient */
    ...
    /* Messages pane with reduced padding */
    ...
    .n8n-chat-widget .chat-input textarea::placeholder {
      color: #999;
      line-height: 40px; /* center placeholder vertically */
    }
  ...
  // 4) Merge config & prevent re-init
  const defaultConfig = {
    webhook: { url: '', route: '' },
